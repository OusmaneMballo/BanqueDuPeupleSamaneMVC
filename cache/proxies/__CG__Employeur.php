...
class Employeur extends \Employeur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Employeur' . "\0" . 'id', '' . "\0" . 'Employeur' . "\0" . 'raisonSocial', '' . "\0" . 'Employeur' . "\0" . 'nom', '' . "\0" . 'Employeur' . "\0" . 'numero', '' . "\0" . 'Employeur' . "\0" . 'adresse', '' . "\0" . 'Employeur' . "\0" . 'client'];
        }

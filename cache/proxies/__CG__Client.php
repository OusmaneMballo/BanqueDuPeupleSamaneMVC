...
class Client extends \Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Client' . "\0" . 'id', '' . "\0" . 'Client' . "\0" . 'nom', '' . "\0" . 'Client' . "\0" . 'prenom', '' . "\0" . 'Client' . "\0" . 'adresse', '' . "\0" . 'Client' . "\0" . 'telephone', '' . "\0" . 'Client' . "\0" . 'profession', '' . "\0" . 'Client' . "\0" . 'salaire', '' . "\0" . 'Client' . "\0" . 'nci', '' . "\0" . 'Client' . "\0" . 'compte', '' . "\0" . 'Client' . "\0" . 'transaction', '' . "\0" . 'Client' . "\0" . 'employeur', '' . "\0" . 'Client' . "\0" . 'user'];
        }

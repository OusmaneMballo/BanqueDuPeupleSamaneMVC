...
class Utilisateur extends \Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Utilisateur' . "\0" . 'id', '' . "\0" . 'Utilisateur' . "\0" . 'nom', '' . "\0" . 'Utilisateur' . "\0" . 'prenom', '' . "\0" . 'Utilisateur' . "\0" . 'adresse', '' . "\0" . 'Utilisateur' . "\0" . 'telephone', '' . "\0" . 'Utilisateur' . "\0" . 'profil', '' . "\0" . 'Utilisateur' . "\0" . 'agence', '' . "\0" . 'Utilisateur' . "\0" . 'compte', '' . "\0" . 'Utilisateur' . "\0" . 'transaction', '' . "\0" . 'Utilisateur' . "\0" . 'user'];
        }

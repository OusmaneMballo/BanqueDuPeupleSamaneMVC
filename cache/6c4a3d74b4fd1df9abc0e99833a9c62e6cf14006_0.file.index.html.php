<?php
/* Smarty version 3.1.30, created on 2020-04-27 08:03:27
  from "/Applications/XAMPP/xamppfiles/htdocs/Mes Sites/DITI/BanqueDuPeupleSamane/src/view/caissier/index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ea675af1b11f9_07843772',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6c4a3d74b4fd1df9abc0e99833a9c62e6cf14006' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/Mes Sites/DITI/BanqueDuPeupleSamane/src/view/caissier/index.html',
      1 => 1587071361,
      2 => 'file',
    ),
  ),
...
function content_5ea675af1b11f9_07843772 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Banque du Peuple | Caissier</title>
...
">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Espace Caissiers</h1>
        </div>
    </div>
    <!--/.row-->
        ...
        <div class="row">
            <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                <div class="panel panel-orange panel-widget border-right">
                    <div class="row no-padding"><em class="fa fa-xl fa-users color-teal" style="font-size:25px"></em>
                        <div class="large">24</div>
                        <div class="text-muted">Clents</div>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 col-md-3 col-lg-3 no-padding">
                <div class="panel panel-red panel-widget ">
                    <div class="row no-padding"><em class="glyphicon glyphicon-cloud color-red" style="font-size:25px"></em>
    ...
    <div class="row">
        ...
        <!--/.col-->
        <div class="col-sm-12">
            <p class="back-link">All Right reserved V 1.3.0 BP  <smal class="color-blue text-lowercase">mballoS</smal></p>
        </div>
    </div>
    <!--/.row-->
</div>

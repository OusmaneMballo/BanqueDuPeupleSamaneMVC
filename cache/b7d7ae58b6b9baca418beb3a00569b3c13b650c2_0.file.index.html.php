<?php
/* Smarty version 3.1.30, created on 2020-04-27 08:04:50
  from "/Applications/XAMPP/xamppfiles/htdocs/Mes Sites/DITI/BanqueDuPeupleSamane/src/view/caissier/virement/index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ea6760235c726_86695069',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b7d7ae58b6b9baca418beb3a00569b3c13b650c2' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/Mes Sites/DITI/BanqueDuPeupleSamane/src/view/caissier/virement/index.html',
      1 => 1587072012,
      2 => 'file',
    ),
  ),
...
function content_5ea6760235c726_86695069 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Banque du Peuple | Virement</title>
...
">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Faire un Virement!</h1>
        </div>
    </div>
    ...
    <div class="panel-body">
        ...
        <div class="alert alert-success">Virement reussie!</div>
        <?php } else { ?>
        <?php if ($_smarty_tpl->tpl_vars['resultat']->value < 0) {?>
        <div class="alert alert-danger">Erreur!, vous ne disposez pas assaie de solde pour faire autant de virement!...</div>
        <?php } else { ?>
        <?php if ($_smarty_tpl->tpl_vars['resultat']->value == 0) {?>
        <div class="alert alert-danger">Erreur! Virement...</div>
        <?php }?>
        <?php }?>
        <?php }?>
        <?php }?>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading"> Furmulaire Virement</div>
                    <div class="panel-body">
                        <form name="add" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
caissier/virement/<?php echo $_smarty_tpl->tpl_vars['user']->value->getEmail();?>
">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="cmptretrait">Numero Compte Retrait *</label>
                                    <input type="text" class="form-control form-group col-md-6" name="cmptretrait" id="cmptretrait"
                                           placeholder="Numero de compte de retrait" required/>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="cmptdepot">Numero Compte Depot *</label>
                                    <input type="text" class="form-control form-group col-md-6" name="cmptdepot" id="cmptdepot"
                                           placeholder="Numero de compte de depot" required/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
